...
c.Spawner.otp_db_hostname = os.environ["OCDBHOST_PORT_5432_TCP_ADDR"]
c.Spawner.otp_db_port = int(os.environ["OCDBHOST_PORT"].split(':')[-1])
c.Spawner.otp_db_username = 'ocadmin'
c.Spawner.otp_db_password = os.environ["OCDBHOST_ENV_owncloudpassword"]
c.Spawner.container_image = 'dataexplab/singleuser'
